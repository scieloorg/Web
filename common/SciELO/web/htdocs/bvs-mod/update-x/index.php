...
<dl>
	<dd>
		<span class="language">
			<a href="index.php?lang=<? print($msg["lang1"]); ?>"><? print($msg["lang1.show"]); ?></a>
			<a href="index.php?lang=<? print($msg["lang2"]); ?>"><? print($msg["lang2.show"]); ?></a>
		</span>
				...
				<form name="formXML" action="php/show.php" method="get">
					...
					<table class="formBox" cellpadding="3" cellspacing="0">
						...
						<tr>
							...
							<td><input type="text" name="lang" size="5" maxlength="300" value="<? print($lang); ?>"></td>
						</tr>
						<tr>
						...
						<tr>
							<td align="right"></td>
							<td><input type="submit" name="submitXML" value="<? print($msg["enter"]); ?>"></td>
						</tr>
					</table>	
					<table>
						<tr>
							<td align="right"><? print($msg["examples"]); ?></td>
							<td>
								<a href="php/show.php?ini=../test/test.ini&lang=<? print($lang); ?>">test</a>
								<a href="php/show.php?ini=../test/test1/test.ini&lang=<? print($lang); ?>">test1</a>
								<a href="php/show.php?ini=../test/test4/test.ini&lang=<? print($lang); ?>&user=test4">test4</a>
								<a href="php/show.php?ini=../test/test6/test.ini&lang=<? print($lang); ?>&user=test6">test6</a>
							</td>
						</tr>
					</table>	
				</form>
			...
			<dd>
				<form name="formXISIS" action="php/documents.php" method="get">
					...
					<table class="formBox" cellpadding="3" cellspacing="0">
						...
						<tr>
							<td align="right"></td>
							<td><input type="submit" name="submitXISIS" value="<? print($msg["enter"]); ?>"></td>
						</tr>
					</table>	
					<table>
						<tr>
							<td align="right"><? print($msg["examples"]); ?></td>
							<td>
								<a href="php/documents.php?ini=../test/test2/test.ini&lang=<? print($lang); ?>&user=test2">test2</a>
								<a href="php/documents.php?ini=../test/test3/test.ini&lang=<? print($lang); ?>&user=test3">test3</a>
								<a href="php/documents.php?ini=../test/test5/test.ini&lang=<? print($lang); ?>&user=test5">test5</a>
								<a href="php/documents.php?ini=../test/test7/test.ini&lang=<? print($lang); ?>&user=test7">test7</a>
							</td>
						</tr>
					</table>
				</form>
			...
			<dd>
				<form action="php/schema-to-struct.php" method="post" name="formSchemaToStruct">
					...
					<span class="captionFormSchemaToStruct">
						<? print($msg["captionFormSchemaToStruct"]); ?>
					</span>
					<table class="formBox" cellpadding="3" cellspacing="0">
						<tr>
						...
						<tr>
							<td align="right"></td>
							<td><input type="submit" name="submitSchemaToStruct" value="<? print($msg["generate"]); ?>"/></td>
						</tr>
					</table>
				</form>
			</dd>
