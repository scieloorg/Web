...
<xsl:stylesheet version="1.3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="topic/item[item] | topic//item[item]">
		<li>
			...
			<a href="#" class="expand-retract" onclick="javascript:showhideLayers('{concat('layer',@id)}','toggleImg{@id}','../image/common/retract.gif','../image/common/expand.gif');return false"><img id="toggleImg{@id}" src="../image/common/expand.gif" border="0" alt="exand"/></a>
