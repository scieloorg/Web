...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:include href="file:///home/scielosp/www/htdocs/xsl/sci_common.xsl"/>
								...
								<p>
									...
									<a>
										...
										<xsl:attribute name="href">http://<xsl:value-of 
											select="SCIELO_INFO/SERVER" /><xsl:value-of 
											select="SCIELO_INFO/PATH_DATA" />scielo.php/lng_pt</xsl:attribute>
										<img>
											<xsl:attribute name="src">http://<xsl:value-of 
												select="SCIELO_INFO/SERVER" /><xsl:value-of 
												select="SCIELO_INFO/PATH_DATA" /><xsl:value-of 
									...
									<a>
										<xsl:attribute name="href">http://<xsl:value-of 
											select="SCIELO_INFO/SERVER" /><xsl:value-of 
											select="SCIELO_INFO/PATH_DATA" />scielo.php/lng_es</xsl:attribute>
										<img>
											<xsl:attribute name="src">http://<xsl:value-of 
												select="SCIELO_INFO/SERVER" /><xsl:value-of 
												select="SCIELO_INFO/PATH_DATA" /><xsl:value-of 
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0042-9686/lng_en/nrm_iso</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0102-311X/lng_en/nrm_iso</xsl:attribute>			
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1413-8123/lng_en/nrm_iso</xsl:attribute>			
...
<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0213-9111/lng_en/nrm_iso</xsl:attribute>			
														Gaceta Sanitaria
													</a>
												</font>
...
<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1415-790X/lng_en/nrm_iso</xsl:attribute>			
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0124-0064/lng_en/nrm_iso</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0034-8910/lng_en/nrm_iso</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1135-5727/lng_en/nrm_iso</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1020-4989/lng_en/nrm_iso</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0036-3634/lng_en/nrm_iso</xsl:attribute>
							...
							<td width="145" valign="top" bgcolor="#DFDFBF">
								...
								<p>
									...
									<a>
										<xsl:attribute name="href">http://<xsl:value-of 
											select="SCIELO_INFO/SERVER" /><xsl:value-of 
											select="SCIELO_INFO/PATH_DATA" />scielo.php/lng_en</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0042-9686/lng_pt/nrm_iso</xsl:attribute>
														Bulletin of the World Health Organization
													</a>
												</font>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0102-311X/lng_pt/nrm_iso</xsl:attribute>
														Cadernos de Saúde Pública
													</a>
												</font>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1413-8123/lng_pt/nrm_iso</xsl:attribute>			
														Cîência e Saúde Coletiva													</a>
												</font>
...
<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0213-9111/lng_pt/nrm_iso</xsl:attribute>
														Gaceta Sanitaria
													</a>
												</font>
...
<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1415-790X/lng_pt/nrm_iso</xsl:attribute>			
														Revista Brasileira de Epidemiologia
													</a>
												</font>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0124-0064/lng_pt/nrm_iso</xsl:attribute>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0034-8910/lng_pt/nrm_iso</xsl:attribute>
														 Revista de Saúde Pública
													</a>
												</font>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1135-5727/lng_pt/nrm_iso</xsl:attribute>
														 Revista Española de Salud Pública
													</a>
												</font>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1020-4989/lng_pt/nrm_iso</xsl:attribute>
													 	Revista Panamericana de Salud Pública
													</a>
												</font>
											...
											<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0036-3634/lng_pt/nrm_iso</xsl:attribute>
														Salud Pública de México
													</a>
												</font>
											...
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0042-9686/lng_es/nrm_iso</xsl:attribute>
														Bulletin of the World Health Organization
													</a>
												</font>
											</p>
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0102-311X/lng_es/nrm_iso</xsl:attribute>
														Cadernos de Saúde Pública
													</a>
												</font>
											</p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1413-8123/lng_es/nrm_iso</xsl:attribute>			
														Cîência e Saúde Coletiva													</a>
												</font>
...
<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0213-9111/lng_es/nrm_iso</xsl:attribute>
														Gaceta Sanitaria
													</a>
												</font>
											</p>
<p>
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1415-790X/lng_es/nrm_iso</xsl:attribute>			
														Revista Brasileira de Epidemiologia
													</a>
												</font>
											...
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													...
													<xsl:attribute name="href">http://<xsl:value-of 
														select="SCIELO_INFO/SERVER" /><xsl:value-of 
														select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0124-0064/lng_es/nrm_iso</xsl:attribute>
														Revista de Salud Pública (Colombia)
													</a>
												</font>
											</p>
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													...
													<xsl:attribute name="href">http://<xsl:value-of 
														select="SCIELO_INFO/SERVER" /><xsl:value-of 
														select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0034-8910/lng_es/nrm_iso</xsl:attribute>
														Revista de Saúde Pública
													</a>
												</font>
											</p>
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1135-5727/lng_es/nrm_iso</xsl:attribute>
														 Revista Española de Salud Pública
													</a>
												</font>
											</p>
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_1020-4989/lng_es/nrm_iso</xsl:attribute>
														Revista Panamericana de Salud Pública
													</a>
												</font>
											</p>
											<p>
												...
												<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
													<a>
														<xsl:attribute name="href">http://<xsl:value-of 
															select="SCIELO_INFO/SERVER" /><xsl:value-of 
															select="SCIELO_INFO/PATH_DATA" />scielo.php/script_sci_serial/pid_0036-3634/lng_es/nrm_iso</xsl:attribute>
													 	Salud Pública de México 
													</a>
												</font>
											</p>
