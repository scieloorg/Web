...
Private Sub mnAbout_Click()
    If BV(Currbv).LoadFilestoConverterProgram Then frmAbout.Show vbModal
End Sub
...
Private Sub mnContent_Click()
    Call frmFindBrowser.CallBrowser(ConvertDirTree.DirNodes("Help of Converter").Parent.FullPath, ConvertDirTree.DirNodes("Help of Converter").Text)
End Sub
