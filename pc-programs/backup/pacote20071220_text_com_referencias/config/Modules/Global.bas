...
Public Const fnLog = 301
Public Const fnDebug = 260
Public Const fnStatus = 256
Public Const fnIdiomas = 257
Public Const fnArqMeses = 258
Public Const fnFST = 259
...
Public Const tagPerTitAbr = 30
Public Const tagFascVol = 31
Public Const tagFascNro = 32
Public Const tagFascTitulo = 33
Public Const tagFascParte = 34
Public Const tagPerISSN = 35
Public Const tagFascNroSeq = 36
Public Const tagFascStatus = 42
Public Const tagLegenda = 43
Public Const tagToCHeader = 48
Public Const tagToCSec = 49
Public Const tagEditorEspecial = 62
Public Const tagFascData = 64
Public Const tagFascDataISO = 65
Public Const TagPubId = 68
Public Const tagCover = 97
Public Const tagPerTitulo = 100
Public Const tagPerTitAlt = 230
