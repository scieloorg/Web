...
<xsl:transform version="1.0" id="ViewNLM-v2-04.xsl" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:util="http://dtd.nlm.nih.gov/xsl/util" xmlns:mml="http://www.w3.org/1998/Math/MathML" exclude-result-prefixes="util xsl">
	<xsl:include href="viewnlm-v2_scielo_01_config.xsl"/>
	<!-- ============================================================= -->
	<!--  2. ROOT TEMPLATE - HANDLES HTML FRAMEWORK                    -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_02_html.xsl"/>
	<!-- ============================================================= -->
	<!--  3. DOCUMENT ELEMENT                                          -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_03_doc.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_03_doc_html.xsl"/>
	<!-- 4 -->
	<xsl:include href="viewnlm-v2_scielo_04_util.xsl"/>
	<!-- ============================================================= -->
	<!-- 6. SUPPRESSED ELEMENTS                                        -->
	<!-- ============================================================= -->
	...
	<xsl:include href="viewnlm-v2_scielo_article_categories.xsl"/>

	
	<!-- ============================================================= -->
	<!--  Keywords                                                     -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_05_keywords.xsl"/>
	<!-- ============================================================= -->
	<!--  Related article                                              -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_related_articles.xsl"/>
	<!-- ============================================================= -->
	<!--  Conference                                                   -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_06_conference.xsl"/>
	<!-- ============================================================= -->
	<!--  NARRATIVE CONTENT AND COMMON STRUCTURES                      -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_narrative.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_person_names.xsl"/>
	...
	<!--  22. SUPPLEMENTARY MATERIAL                                   -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_supplmat.xsl"/>
	<!-- ============================================================= -->
	<!--  23. DISPLAY FORMULA, CHEM-STRUCT-WRAPPER                     -->
	<!-- ============================================================= -->
	<!-- both are grouping elements to keep parts together -->
	<xsl:include href="viewnlm-v2_scielo_dispformula.xsl"/>

	<!-- ============================================================= -->
	<!--  24. FORMATTING ELEMENTS                                      -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_format.xsl"/>
	
	<!-- ============================================================= -->
	<!--  24. SEMANTICS ELEMENTS                                      -->
	<!-- ============================================================= -->
	<xsl:include href="viewnlm-v2_scielo_26_semantics.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_xyz.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_array.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_caption.xsl"/>

	<xsl:include href="viewnlm-v2_scielo_fig_at_the_end.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_table_at_the_end.xsl"/>
	
	<xsl:include href="viewnlm-v2_scielo_mode_front.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_mode_back.xsl"/>

	<xsl:include href="viewnlm-v2_scielo_titles.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_48_words.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_misc.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_citations.xsl"/>
	<xsl:include href="viewnlm-v2_scielo_end_citation.xsl"/>
</xsl:transform>
