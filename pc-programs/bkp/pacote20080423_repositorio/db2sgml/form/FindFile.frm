...
Private Sub cmdOK_Click()
    ...
    If Len(File1.FileName) > 0 Then
        ...
        fn = 1
        Open "brwrpath.txt" For Output As fn
        Print #fn, BrowserPath
        Close fn
        Unload Me
    End If
End Sub
...
Sub CallBrowser(helpPath As String, helpFile As String)
    ...
    If Len(BrowserEXE) > 0 Then
        'If FileExist(helpPath, IdiomsInfo(CurrIdiomHelp).Code + helpFile) Then
            Shell BrowserEXE + " " + helpPath + "\" + helpFile
...
Private Sub Form_Load()
    'Caption = App.Title + " - " + ConfigLabels.Config_WebBrowserPath
    'CmdOk.Caption = ConfigLabels.ButtonOK
    'CmdCancel.Caption = ConfigLabels.ButtonCancel
    CmdOK.Caption = "OK"
