...
Sub CallBrowser(helpPath As String, helpFile As String)
    ...
    If Len(BrowserEXE) > 0 Then
        ...
        MsgBox BrowserEXE + Chr(32) + helpPath + "\" + IdiomHelp(CurrIdiomHelp).code + helpFile
            Shell BrowserEXE + Chr(32) + helpPath + "\" + IdiomHelp(CurrIdiomHelp).code + helpFile
        Else
            MsgBox MsgHelpFilenotfound
        End If
    Else
        MsgBox MsgNoWebBrowserwasselected
    End If
End Sub
