...
'--------------------------------------------------------------------------------
Function MakeConversion(ByVal DocMarkup As String, ByVal DocBody As String, ByVal DocDB As String) As Boolean
    Dim BD As ClDBDoc
    ...
    If ret Then
        ...
        If SciELODoc.MARKUP_IsValidDTD(PathMarkup, DocMarkup) Then
            ...
            others = SciELODoc.MARKUP_CheckArticleDates() And SciELODoc.MARKUP_checkPreviousPIDs
            ...
            If NoErrorFound And ConfigOK And OrderOK And others Then
                ' DocId
        ...
        Call Msg.WriteLogDatabase(DocMarkup, PathBase + PathSep + DocDB, ConversionOK, (ErrorCount > 0) Or RefLinkError)
