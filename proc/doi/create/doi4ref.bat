...
doi/create_update/ReadScilista.bat create $1 10.1590 bireme p@s5w0Rd bireme.crossref@gmail.com ref pacote
rem doi/create_update/ReadScilista.bat create $1 10.1590 bireme p@s5w0Rd scielo@bireme.br ref individual
