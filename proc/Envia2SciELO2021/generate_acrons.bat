...
rem Envia2SciELO2021/generate_acrons
...
call Envia2SciELO2021/InformaLog.bat ${LOGFILE} $0 "In background generate and transfer acrons.txt"
${CISIS_DIR}/mx ${TITLE_MST} lw=999 "pft=if v50='C' then v68/ fi" now > ${TMP_PATH}/acrons.txt
call Envia2SciELO2021/transf.bat ${LOGFILE} ${TMP_PATH} acrons.txt bin
...
${CISIS_DIR}/mx ${TITLE_MST} lw=999 "pft=if v50='C' then 'call Envia2SciELO2021/id_generate.bat ${TMP_PATH} ${BASES_WORK_PATH}/',v68,'/',v68,' ',v68,'.id'/, fi" now > ${TMP_PATH}/call_generate_acrons.bat
