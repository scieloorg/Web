...
rem Envia2SciELO2021/generate_issue
...
call Envia2SciELO2021/InformaLog.bat ${LOGFILE} $0 "In background generate and transfer ${ACRON_ISSUE} present in scilista"
...
call Envia2SciELO2021/id_generate.bat ${TMP_PATH} ${TMP_PATH}/${ACRON_ISSUE} ${ACRON_ISSUE}.id
