...
$MX cipar=$CIPFILE ARTIGO btell=0 "R=$PID$ or hr=$PID$" "proc='d691a691{$COLLECTION{'" "proc=@pft/get_data_from_query_and_log.prc"   lw=9999 "pft=@pft/selection.pft" now >> $TEMP_PATH/sel.sh
