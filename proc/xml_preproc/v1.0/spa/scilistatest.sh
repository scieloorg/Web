...
Foram encontrados erros na scilistaxml.lst do processamento SciELO SP de $(date '+%d/%m/%Y'). Por favor verifiquem:
...
mailx marcacao@scielo.org -b "renata.almeida@scielo.org, ednilson.gesseff@scielo.org" -c "infra@scielo.org" -s "Erros na scilistaxml.lst - SciELO SP - $(date '+%d/%m/%Y')" < msg-erro.txt
...
A scilistaxml.lst do processamento SciELO SP de $(date '+%d/%m/%Y') esta correta.
...
mailx marcacao@scielo.org -b "renata.almeida@scielo.org, ednilson.gesseff@scielo.org" -c "infra@scielo.org" -s "Scilistaxml.lst - SciELO SP - $(date '+%d/%m/%Y') esta OK" < msg-ok.txt
