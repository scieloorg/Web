...
#mx_path = '/home/ednilson.gesseff/cisis/5.6.alfa2/linux/lindG4/'
#mx_path = '/usr/local/bireme/cisis/5.6.alfa2/linux/lindG4/'
scilista = '../serial/scilistaxml.lst'
registered_filename = '/tmp/registered.txt'
issue_db = '/bases/spa.000/serial/issue/issue'
...
if scilista_issues is None:
    print('not found scilistaxml.lst')
