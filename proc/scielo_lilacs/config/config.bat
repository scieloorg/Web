echo Tools
export wxis=cisis.lind/wxis
export mx=cisis.lind/mx

echo Environment SciELO
export  title=/bases/scielo-lilacs/bases-work/scielo_lilacs/title/title
export  issue=/bases/scielo-lilacs/bases-work/scielo_lilacs/issue/issue
export  artigo=/bases/scielo-lilacs/bases-work/artigo/artigo
