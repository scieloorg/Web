...
$MX cipar=$FILE_CIPAR ARTIGO btell=0 "HR=S$ISSUEPID$" lw=9999 "pft=if p(v70) then (v880[1],v70^i*0.3,'|',v70^*,|^c|v70^c,|^s|v70^s,|^p|v70^p,'|',|^1|v70^1,|^2|v70^2,/) fi" now >> $SEQ_DB_v70
