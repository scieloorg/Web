...
$MX cipar=$FILE_CIPAR ARTIGO lw=9999 btell=0 hr=$ISSUE_PID$ "pft=#,'$BATCHES_PATH/genDBLang/doForArticle.bat $1 ',mfn,' ',f(l(['$DBLANG']v880),1,0),' ',v880*1.9/" now> temp/langs_DoForArticle.bat
