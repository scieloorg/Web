...
function new_titles($count, $rep)
{
	...
	$serviceUrl = "http://" . $this->applServer . "/cgi-bin/wxis.exe/webservices/wxis/?IsisScript=listNewTitles.xis&database=".$databasePath ."title/title&gizmo=GIZMO_XML&count=" . $count;
	if ($rep){
		$serviceUrl .="&rep=".$rep;
