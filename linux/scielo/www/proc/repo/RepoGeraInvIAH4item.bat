...
then
	echo sem acronimo
	call batch/GeraInvertido.bat ../bases-work/artigo/artigo temp/repo_fst_search.fst ../bases-work/iah/$2/search
	call batch/GeraInvertido.bat ../bases-work/artigo/artigo temp/repo_fst_searchp.fst ../bases-work/iah/$2/searchp
else
	echo acronimo $3
	call batch/GeraInvertido.bat ../bases-work/$3/$3 temp/repo_fst_search.fst ../bases-work/iah/$2$3/search
	call batch/GeraInvertido.bat ../bases-work/$3/$3 temp/repo_fst_searchp.fst ../bases-work/iah/$2$3/searchp
fi
