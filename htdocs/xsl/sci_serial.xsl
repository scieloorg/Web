...
-->
	...
	<!--
		formacao do link de p঩na secund౩a
	-->
	...
	<!--
		formacao dos links das p঩nas secund౩as
	-->
		...
		<div class="mainContent">
			...
			<div class="search">
				...
				<form name="searchForm" action="http://{//SCIELO_INFO/SERVER}/cgi-bin/wxis.exe/iah/" method="post">
					...
					<select class="inputText mini" name="indexSearch">						<option selected="true" value="^nTo^pTodos os índices^eTodos los indices^iAll indexes^d*^xTO ^yFULINV">
