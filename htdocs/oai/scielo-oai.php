...
$identifier = cleanParameter($identifier);
    ...
    function parseResumptionToken ( $resumptionToken )
    {
        ...
        if (! preg_match("/^HR__S([0-9X]{4}-[0-9X]{4})[0-9]{13}:([0-9X]{4}-[0-9X]{4})?:((19|20)\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))?:((19|20)\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))?:(oai_dc)(_agris)?$/" , $resumptionToken ) and ! preg_match("/DTH__((19|20)\d\d(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01]))__([0-9X]{4}-[0-9X]{4})[0-9]{9}:([0-9X]{4}-[0-9X]{4})?:((19|20)\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))?:((19|20)\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))?:(oai_dc)(_agris)?$/" , $resumptionToken )){
            return false;
        }
