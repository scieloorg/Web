...
class DOMIT_Utilities {
	...
	*/
	public static function toNormalizedString (&$node, $subEntities=false, $definedEntities=array()) {
		$node_level = 0;
		$response = '';
	...
	*/
	public static function getNormalizedString(&$node, $node_level, $subEntities=false, $definedEntities=array()) {
		$response = '';
