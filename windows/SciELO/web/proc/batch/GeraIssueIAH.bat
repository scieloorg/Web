...
if errorlevel==1 batch\AchouErro.bat %0 Gera Issue IAH
...
if errorlevel==1 batch\AchouErro.bat %0 ..\bases-work\issue\issue proc:@prc\issue2.prc copy:..\bases-work\issue\issue
