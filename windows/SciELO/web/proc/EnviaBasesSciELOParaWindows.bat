...
rem Windows call batch\ConverteBasesSciELO.bat %1\serial temp\transf2linux %5

rem Gera arquivo de parametros do FTP
call batch\CopiaArquivo.bat %2 temp\EnviaBases.txt


rem Windows echo lcd temp\transf2linux>> temp\EnviaBases.txt
echo lcd %1\serial>> temp\EnviaBases.txt
