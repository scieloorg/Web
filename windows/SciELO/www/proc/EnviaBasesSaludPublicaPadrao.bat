...
echo EnviaBasesScielo.bat \scielo transf\EnviaBasesLogOnSaludPublica.txt log\EnviaBasesSaludPublicaPadrao.log cria 3
echo.
echo Tecle CONTROL-C para sair ou ENTER para continuar...

pause > nul

EnviaBasesScielo.bat \scielo transf\EnviaBasesLogOnSaludPublica.txt log\EnviaBasesSaludPublicaPadrao.log cria 3