...
call batch\ConverteMaster.bat ..\bases\newissue\newissue %2\issue\issue
call batch\ConverteMaster.bat %1\code\newcode %2\code\newcode
...
if errorlevel==1 batch\AchouErro.bat %0 mx seq:temp\scilista-envia.lst_ lw:9000 pft:call_batch_ConverteBasesSciELO.bat
rem chmod 700 temp\ConverteBasesSciELO.bat
