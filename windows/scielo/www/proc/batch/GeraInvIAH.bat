...
if errorlevel==1 batch/AchouErro.bat %0 mx %2 - criacao batch temp\GeraInvIAH.bat passo 1
rem 2
...
if errorlevel==1 batch/AchouErro.bat %0 mx %2 - criacao batch temp\GeraInvIAH.bat passo 2
rem 3
...
if errorlevel==1 batch/AchouErro.bat %0 mx %2 - criacao batch temp\GeraInvIAH.bat passo 3
rem chmod 700 temp\GeraInvIAH.bat
