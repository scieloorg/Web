...
call batch\GeraInvertido.bat ..\bases-work\title\title fst\codigoRevista.fst temp\codigoRevista
...
if errorlevel==1 batch\AchouErro.bat %0 mx seq:scilista.lst_ lw:9000 pft:call_batch_CriaRevistaNova.bat
rem chmod 700 temp\CriaRevistasNovas.bat
